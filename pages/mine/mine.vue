<template>
	<view>
		<view class="header">
			<view class="bg">
				<view class="box">
					<view class="box-hd">
						<view class="avator">
							<image src="../../static/user/face.jpg" mode="widthFix"></image>
						</view>
						<!-- <view class="phone-number">{{$store.state.userInfo.mobile}}</view> -->
					</view>
					<view class="box-bd">
						<view class="item">
							<view class="icon"><image src="../../static/user/message.png" mode="widthFix"></image></view>
							<view class="text">我的通知</view>
						</view>
						<view class="item">
							<view class="icon"><image src="../../static/user/favorite.png" mode="widthFix"></image></view>
							<view class="text">我的收藏</view>
						</view>
						<view class="item">
							<view class="icon"><image src="../../static/user/service.png" mode="widthFix"></image></view>
		...
		<view class="list-content">
			<view class="list">
				<view class="li noborder" @click="toPersonal" >
			...
			<view class="list">
				<view class="li noborder" @click="toLogout">
